                ...
                <form class="form login__form">
                    <div class="form__recovery">
                        ...
                        <div class="form__recovery-inputs">
                            ...
                            <div class="form__recovery-input">
                                <input type="text" ref="num2" id="num2" v-model="num2" maxlength="1"
                                       v-on:keyup="getFocus('num3')">
                            </div>
                            <div class="form__recovery-input">
                    ...
                    <div class="form__footer">
                        <p>Код действителен в течении 10 минут</p><a class="form__link" href="">Отправить код еще
                        раз</a>
                    </div>
                </form>
            </section>
    ...
    methods: {
      ...
      onSubmit(e) {
        ...
        this.$store.dispatch('user/registrationConfirm', data).then(() => {
          ...
          this.$router.push({name: 'profile_create', params: {isOneExist: false}})
        }).catch((error) => {
