                ...
                <div class="paper filter">
                    <div class="filter__col">
                        ...
                        <form class="filter__item">
                            ...
                            <div class="filter__item-wrap">
                                <label class="input-radio">
                                    <input class="visually-hidden" type="radio" name="alphabet" value="asc"
                                           v-model="sortType"><span class="input-radio__custom"></span>
                                    <p>А - Я</p>
                                </label>
                                <label class="input-radio">
                                    <input class="visually-hidden" type="radio" name="alphabet" value="desc"
                                           v-model="sortType"><span class="input-radio__custom"></span>
                                    <p>Я - А</p>
                                </label>
                            </div>
                        ...
                        <form class="filter__item" v-else-if="picked==='recipe'">
                            ...
                            <div class="filter__item-wrap">
                                <label class="input-radio">
                                    <input class="visually-hidden" type="radio" name="type" value="first"
                                           v-model="typeOfView" @click="resetSort"><span
                                        class="input-radio__custom"></span>
                                    <p>1 вид</p>
                                </label>
                                <label class="input-radio">
                                    <input class="visually-hidden" type="radio" name="type" value="second"
                                           v-model="typeOfView" @click="resetSort"><span
                                        class="input-radio__custom"></span>
                                    <p>2 вид</p>
                                </label>
                    ...
                    <div class="filter__col">
                        ...
                        <div class="filter__item">
                            ...
                            <div class="datepicker filter__datepicker">
                                <input type="date" v-model="fromDate" @change="sendDates()">
                            </div>
                            <span>&ndash;</span>
                            <div class="datepicker filter__datepicker">
                        ...
                        <div class="filter__item">
                            ...
                            <div class="filter__item-wrap">
                                <label class="input-radio">
                                    <input class="visually-hidden" type="radio" name="type" value="ingredient"
                                           v-model="picked" @click="resetSort"><span class="input-radio__custom"></span>
                                    <p>Ингредиенты</p>
                                </label>
                                <label class="input-radio">
                                    <input class="visually-hidden" type="radio" name="type" value="recipe"
                                           v-model="picked" @click="resetSort"><span class="input-radio__custom"></span>
                                    <p>По рецептам</p>
                                </label>
                            </div>
                    ...
                    <div class="filter__col span-2" v-if="typeOfView==='first' && picked==='recipe'">
                        <div class="tabs__buttons">
                            <button class="tabs__btn" :class="{ active: typeOfMeal === 'breakfast'}" type="button"
                                    @click="getFilteredByMealOfAll('breakfast')">Завтрак
                            </button>
                            <button class="tabs__btn" :class="{ active: typeOfMeal === 'dinner' }" type="button"
                                    @click="getFilteredByMealOfAll('dinner')">Перекус
                            </button>
                            <button class="tabs__btn" :class="{ active: typeOfMeal === 'lunch' }" type="button"
                                    @click="getFilteredByMealOfAll('lunch')">Обед
                            </button>
                            <button class="tabs__btn" :class="{ active: typeOfMeal === 'supper' }" type="button"
                                    @click="getFilteredByMealOfAll('supper')">Ужин
                            </button>
                        </div>
                    </div>
                </div>
                <PurchaseIngredient v-if="picked==='ingredient'" :sortType="sortType" :fromDate="fromDate"
                                    :toDate="toDate" />

                <section v-else-if="picked==='recipe'" class="scheduler-food">
                    <PurchaseRecipe v-for="recipe in recipes" :key="recipe.date" :recipeData="recipe"
                                    :typeOfView="typeOfView" :typeOfMeal="typeOfMeal" :sortType="sortType"
                ...
                <div class="modal__container">
                    ...
                    <div class="modal__wrap-hidden" v-show="cookBySelf===true">
                        ...
                        <div class="modal__btn-group">
                            ...
                            <button class="button button--no-fill modal__btn-close-wrap-hidden" type="button"
                                    @click="cookBySelf=false">
                    ...
                    <ul class="user__list">
                        <li v-for="(profile, key) in listProfiles" :key="key">
                            <label class="user__profile">
                                ...
                                <p v-if="profile.fullName.firstName != null" class="user__name">
                                    {{profile.fullName.firstName}}</p>
                            </label>
                        </li>
                    </ul>
...
<script>
  ...
  export default {
    ...
    methods: {
      sendDates() {
        let $this = this
        let dates = '?dateFrom='+this.fromDate+'&dateTo='+this.toDate;
        this.$store.dispatch('subscription/getShopListAction', dates).then(()=>{
            $this.computeRecipes()
        }
        ).catch()
      },
